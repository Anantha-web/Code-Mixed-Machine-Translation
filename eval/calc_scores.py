...
TEMP_OUTPUT_DIR = f"{SCRATCH_DIR}/preprocessed/mt_outputs/val_temp"
OUTPUT_DIR = f"{SCRATCH_DIR}/preprocessed/mt_outputs/val"
NORM_OUTPUT_DIR = f"{SCRATCH_DIR}/preprocessed/mt_outputs/val_norm"
